...
echo "运行以下命令："
echo "  wrangler r2 object put course-demo/justincourse-faq/cloudflare-mcp-deployment.md --file=documents/example-faq.md"
echo ""
...
echo ""
echo "📖 更多信息："
echo "  - 完整功能文档: documents/KNOWLEDGE_BASE_FEATURES.md"
echo "  - 项目总结: documents/PROJECT_SUMMARY.md"
echo "  - API 端点列表: curl $BASE_URL/api"
echo ""
echo "💬 需要帮助？查看文档或运行 ./scripts/test-knowledge-base.sh 进行完整测试"
